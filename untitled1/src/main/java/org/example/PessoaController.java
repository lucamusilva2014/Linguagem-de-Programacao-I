...
public class PessoaController {
    ...
    @FXML
    private static Button bt_salvar;
    ...
    @FXML
    private static TextField tf_email;

    @FXML
    private static TextField tf_idade;

    @FXML
    private static TextField tf_nome;
